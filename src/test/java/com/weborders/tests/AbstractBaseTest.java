...
public abstract class AbstractBaseTest {
    ...
    //static solve issue NullPointerException issue
    //when we have couple classes within same test in the xml runner
    ...
    public void beforeTest() {
        extentReports = new ExtentReports();//initialize it
        String reportPath = "";
        ...
        extentHtmlReporter = new ExtentHtmlReporter(reportPath); //where report will be stored
    ...
    public void afterTest(){
        extentReports.flush();//release the report
    }
